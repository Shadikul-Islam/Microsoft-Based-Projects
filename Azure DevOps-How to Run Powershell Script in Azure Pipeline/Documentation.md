## <p align=center>How to Run Powershell Script in Azure Pipeline in Azure DevOps <br> <br> </p>
| **SL** | **Topic** |
| --- | --- |
| 01 | [What is Azure DevOps?](#01) |
| 02 | [Azure DevOps Core Services](#02) |
| 03 | [What is Azure Pipeline?](#03) |
| 04 | [What is Powershell Scripting?](#04) |
| 05 | [How to Run Powershell Script in Azure Pipeline?](#05) |
...
In here I will discuss about the **Azure Pipeline**.
...
### <a name="04">:diamond_shape_with_a_dot_inside: &nbsp;What is Powershell Scripting?</a>
...
### <a name="05">:diamond_shape_with_a_dot_inside: &nbsp;How to Run Powershell Script in Azure Pipeline?</a>
